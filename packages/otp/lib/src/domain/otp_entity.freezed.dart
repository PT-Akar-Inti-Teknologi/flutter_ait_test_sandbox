...
class _$_OtpEntity implements _OtpEntity {
  const _$_OtpEntity({required this.otp, required this.userId});
  ...
  @override
  String toString() {
    return 'OtpEntity(otp: $otp, userId: $userId)';
  }
...
abstract class _OtpEntity implements OtpEntity {
  const factory _OtpEntity(
      {required final String otp, required final String userId}) = _$_OtpEntity;
